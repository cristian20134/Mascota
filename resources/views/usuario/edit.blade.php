...
@section('breadcrumb')
<li class="breadcrumb-item active">Editar Registro de Usuario</li>
@endsection
            ...
            <form method="POST" action="{{ route('usuario.update', ['u'=>$u->id] )}}">
              ...
              @method('PUT')
                ...
                <div class="form-group">
                    ...
                    value="{{ old('apellido_paterno') ?: $u->apellido_paterno}}">
                  ...
                  <div class="form-group">
                    ...
                    value="{{ old('apellido_materno') ?: $u->apellido_materno}}">
                  ...
                  <div class="form-group">
                    ...
                    value="{{ old('rut_usuario') ?: $u->rut_usuario}}">
                    @error('rut_usuario')
                    <span class="error invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    value="{{ old('email_usuario') ?: $u->email_usuario}}">
                    @error('email_usuario')
                    <span class="error invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    value="{{ old('telefono_usuario') ?: $u->telefono_usuario}}">
